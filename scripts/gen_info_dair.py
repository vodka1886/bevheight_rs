...
def generate_info_dair(dair_root, split):    
    infos = mmengine.load("data/single-infrastructure-split-data.json")
...
def main():
    ...
    mmengine.dump(train_infos, './data/dair-v2x-i/dair_12hz_infos_train.pkl')
    mmengine.dump(val_infos, './data/dair-v2x-i/dair_12hz_infos_val.pkl')
